...
public sealed class PapHandler : IDisposable
{
    ...
    public const string LoadMotionPacks = "E8 ?? ?? ?? 00 48 8B 44 24 ?? 49 89 04 24"; // 1 - match
    public const string LoadMotionPacks2 = "E8 ?? ?? ?? 00 48 8B 44 24 ?? 48 89 03"; // 2
    public const string LoadMigratoryMotionPack = "E9 ?? ?? ?? 00 8B 84 24 ?? ?? 00 00 48 8D"; // 2
